...
namespace LostAndFound.API.Migrations
{
    ...
    [Migration("20240105025426_ChangeCommentPathFieldInCommentTable")]
    partial class ChangeCommentPathFieldInCommentTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LostAndFound.Core.Entities.GiveawayParticipant", b =>
                {
                    ...
                    b.Property<bool>("IsChosenAsWinner")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("LostAndFound.Core.Entities.ReportMedia", b =>
                {
            ...
            modelBuilder.Entity("LostAndFound.Core.Entities.Storage", b =>
                {
                    ...
                    b.HasIndex("MainStorageManagerId");

                    b.ToTable("Storages");
                });

            modelBuilder.Entity("LostAndFound.Core.Entities.TransferRecord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("CategoryPost", b =>
                {
                    ...
                    b.HasOne("LostAndFound.Core.Entities.Post", null)
                        .WithMany()
            ...
            modelBuilder.Entity("LostAndFound.Core.Entities.Storage", b =>
                {
                    ...
                    b.HasOne("LostAndFound.Core.Entities.User", "User")
                        .WithMany("Storages")
                        .HasForeignKey("MainStorageManagerId")
                        .OnDelete(DeleteBehavior.NoAction);
